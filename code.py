...
async def math_callback(e):
    ...
    if data == "MODE_ADV":
        await e.edit("الوضع المتقدم مفعل، يمكنك استخدام الأدوات المتقدمة!", buttons=get_calc_keyboard("ADV"))
        session['mode'] = "ADV"

    elif data == "MODE_BAS": 
        await e.edit("الوضع الأساسي مفعل، يمكنك استخدام الأدوات الأساسية!", buttons=get_calc_keyboard("BASIC"))
        session['mode'] = "BASIC"
