...
async def forward_whisper(event):
    ...
    # إعلام القروب أن هناك همسة جديدة
    ...
    try:
        if msg.media:
            ...
            await client.send_message(data["to"], msg.text)
    except Exception as e:
        await event.respond(f"❗ تعذر إرسال الهمسة للطرف الآخر: {str(e)}")
        return
